...
<template>
  ...
  >
    <div class="w-full h-auto mb-6 flex justify-center">
      <img
        :src="Logo"
        alt="Logo"
        srcset=""
        class="h-full w-full flex justify-start items-start block dark:hidden"
      ...
      <img
        ...
        alt="Logo"
        srcset=""
        class="h-full w-full flex justify-start items-start hidden dark:block"
        :class="{ hidden: isCollapsed }"
      />
    </div>
